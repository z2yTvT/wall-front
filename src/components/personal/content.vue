...
<!--    <div class="info">基本信息</div>-->
    <div class="favHeader">
      <div
        ...
        "
      >
        <i class="el-icon-star-on" style="margin-right: 10px"></i>基本信息：
      </div>
    </div>
    <el-row style="margin-top: 20px">
      <el-col :span="12" style="border-right: 1px #eee solid">
        ...
        <div style="display: flex; margin-bottom: 30px">
          ...
          <p style="font-size: 14px; color: #999; margin-left: 10px" v-if="userObj.sex == 1">
            男
          </p>
          <p style="font-size: 14px; color: #999; margin-left: 10px" v-else-if="userObj.sex == 0">
            女
          </p>
        </div>
        <div style="display: flex; margin-bottom: 30px">
        ...
        <div style="display: flex; margin-bottom: 30px">
          ...
          <p style="font-size: 14px; color: #999; margin-left: 10px">{{userObj.signature}}</p>
        </div>
        <el-button
      ...
      <el-col :span="12" v-if="display == true">
        <el-form ref="form" :model="form" label-width="100px" size="small">
          <el-form-item label="头像" prop="pic" class="changeImg">
            <el-upload

    ...
    <div class="content">
      <div style="display: flex; justify-content: space-between">
        <div class="left">
          ...
          <div style="right;margin-right: 10px" v-if="canModify">
            <el-button  @click="changeArt1" >编辑文章</el-button>
            <el-button  style="margin-left:10px" @click="deleteArt" >删除文章</el-button>
          </div>
          <div class="info">
            <el-avatar
                :size="55"
          ...
          <div style="margin-bottom: 20px">
            <el-row>
              ...
              >
                ...
                >
                <el-button
                    style="background: #fff; color: #409eff;margin-left: 10px"
                    type="primary"
                    @click="nozan()"
...
<!--            </p>-->
      ...
      <textarea name="" id="" cols="100" rows="13"
                placeholder="发表你的评论"
                v-model="textarea"
      ></textarea>
        <div slot="footer" class="dialog-footer">
          <el-button @click="dialogFormVisible = false">取 消</el-button>
          <el-button type="primary" @click="submitComment" style="margin-left: 10px"
          >确 定</el-button
          >
        </div>
      </el-dialog>
        ...
        .then((res) => {
          if (res.status == 200) {
            if (res.data.code == 0) {
              ...
              _self.listData = da;
              console.log(res.data.data.articleUserId)
              this.author = res.data.data.articleUserId;
              let loginUserId = JSON.parse(localStorage.getItem("userInfo")).userId;
              this.canModify = this.author == loginUserId || loginUserId == 1;
            }
          }
        })
        .catch((err) => {
